...
set(Qt5Help_VERSION_STRING 5.15.4)
...
if (NOT TARGET Qt5::Help)
    ...
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/QtHelp/5.15.4"
        "${_qt5Help_install_prefix}/include/QtHelp/5.15.4/QtHelp"
    )
    ...
    foreach(_module_dep ${_Qt5Help_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.4 ${_Qt5Help_FIND_VERSION_EXACT}
    ...
    _populate_Help_target_properties(RELEASE "libQt5Help.so.5.15.4" "" FALSE)
